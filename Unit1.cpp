        ...
        : TForm(Owner)
{
        ...
        /*for(int i=0; i<info.size(); i++){
                ...
                // 18 output data for exactly one satellite, for example the first:
                out << setw(13) << setprecision(13) << info[i][0] << endl;
        }*/
        // 18 output the data of two satellites and draw graphs of this data for two satellites:
        for(int i=0; i<info.size(); i++){
